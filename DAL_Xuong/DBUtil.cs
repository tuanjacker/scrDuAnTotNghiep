...
namespace DAL_PolyCafe
{
    public class DBUtil
    {
        public static string connString = @"Data Source=TRANNGUYENHOANG\SQLEXPRESS;Initial Catalog=Xuong_QuanLyThuVien;Integrated Security=True;Trust Server Certificate=True";
